...
class CenterPredictor(nn.Module, ):
    ...
    def forward(self, x, gt_score_map=None):
        """ Forward pass with input x. """
        score_map_ctr, size_map, offset_map = self.get_score_map(x) # center point, HW size, HW offset
    ...
    def get_score_map(self, x):
        ...
        score_map_ctr = self.conv5_ctr(x_ctr4) # center point: (B,1,16,16)
        ...
        score_map_offset = self.conv5_offset(x_offset4) # W,H offset: (B,2,16,16)
        ...
        score_map_size = self.conv5_size(x_size4) # H,W size: (B,2,16,16)
